...
const ConnectWalletBtn = () => {
      ...
      <Portal appendToParentPortal={false}>
        <PopoverContent w="20rem">
          <Box bgColor="gray.750" rounded="1rem" p={6}>
            <Text fontSize="1.6rem" color="white" mb={2}>Wallet Balance</Text>
            {balance.isLoading && !balance.data ? <Skeleton
              ...
              <Text
                ...
                fontSize="1.5rem"
                color="gray.300">
                {normalizeNumber(balance.data!.formatted || 0, 5)} {balance.data!.symbol}
              </Text>}
          </Box>
          <Button
            onClick={() => disconnect()}
  ...
  ) : <Button variant="magenta" onClick={openConnect}>Connect Wallet</Button>
}
