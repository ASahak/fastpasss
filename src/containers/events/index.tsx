...
const Events = ({ data, loading }: IProps) => {
  ...
  const content = useMemo(() => {
    if (loading) return <Flex justifyContent="center" alignItems="center" w="full" h="full">
      <Spinner
        w="40px"
        h="40px"
        size="4px"
  ...
  return (<VStack spacing="1.8rem" w="full" flex={1}>
    <Flex justifyContent="space-between" w="full">
      <Heading fontSize="2.4rem" color="white">Trending Events near Yerevan</Heading>
      <Box/>
    </Flex>
